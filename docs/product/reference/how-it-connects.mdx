...
- Global search and the command palette (`/api/search`) index User, legacy Task, SOP, Doc, Department, Meeting and OKR. Items, Boards, Spaces and Whiteboards are not searchable.
