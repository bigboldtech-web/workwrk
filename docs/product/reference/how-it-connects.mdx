...
**The appraisal letter is now wired.** `/api/reviews/[id]/appraisal-letter` used to have no caller; it now has a **Generate appraisal letter** button on every COMPLETED review, both the subject's own My Review card and each row of the manager's Team Reviews list. The route is org-scoped and only the subject, the reviewer, or someone with manage rights over the subject can read it. (Listed here because this section is where the old gap was called out.)
