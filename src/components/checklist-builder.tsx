        ...
        <div>
                ...
                {editing && (
                  <div className="group/divider relative h-0">
                    <div className="absolute inset-x-0 -top-1 h-2 z-10 flex items-center justify-center opacity-0 group-hover/divider:opacity-100 transition-opacity cursor-pointer"
                      ...
                      <div className="flex items-center gap-2 px-3 py-0.5 rounded-full bg-[#0073EA] text-white text-[10px] font-medium shadow-sm">
                  ...
                  <div>
                      ...
                      return (
                        <div key={step.id}
                          className={`flex items-center gap-2 px-4 py-2 cursor-pointer border-l-2 transition-all ${
                            isSelected ? "border-l-[#0073EA] bg-blue-50/60" : "border-l-transparent hover:bg-surface-2"
                          }`}
                    ...
                    {editing && (
                      <button onClick={() => addStep(section.id)}
                        className="w-full flex items-center gap-2 px-4 py-2 text-xs text-muted hover:text-[#0073EA] hover:bg-surface-2 transition-colors border-t border-border/50">
          ...
          {editing && sections.length > 0 && (
            <div className="flex items-center justify-center py-3">
              <button onClick={addSection} className="flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-dashed border-border text-xs text-muted hover:text-[#0073EA] hover:border-blue-300 transition-colors">
                ...
                <button key={t} disabled={!editing}
                  ...
                  className={`px-3 py-1 rounded-full text-xs font-medium transition-colors ${
                    selectedStepObj.type === t
                      ? t === "approval" ? "bg-amber-500/20 text-amber-400 border border-amber-500/30" : "bg-blue-50 text-blue-700 border border-blue-200"
