...
export function SopFoldersTagsManager() {
  ...
  function renderNode(node: FolderNode, depth: number): React.ReactNode {
    ...
    return (
      <div key={node.id}>
        <div
          className="group flex items-center gap-2 rounded-md px-2 py-1.5 text-base hover:bg-surface-2 transition-colors"
        ...
        >
          ...
          <Badge variant="outline" className="text-xs h-5 shrink-0" title={depth === 0 ? "SOPs in this category, subcategories included" : "SOPs in this subcategory"}>
    ...
    <div className="space-y-4">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted mt-3 leading-relaxed flex items-start gap-1.5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
              {filteredTags.map((t) => (
                <div key={t.name} className="flex items-center gap-2 rounded-lg border border-border bg-surface-2 p-2 text-xs">
                  ...
                  <Badge variant="outline" className="text-xs h-5">{t.count}</Badge>
              ...
              {filteredTags.length === 0 && (
                <div className="col-span-full text-xs text-muted text-center py-3">
