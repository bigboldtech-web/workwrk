...
function Section({
  ...
  return (
    <section>
      <h4 className="text-micro font-semibold uppercase tracking-wider text-muted-2 mb-2 px-1">{title}</h4>
          ...
          return (
            ...
            >
              ...
              <span className="min-w-0 flex-1">
                ...
                <span className="block text-xs text-muted-2 truncate">{o.tagline}</span>
              </span>
            </button>
          );
        })}
