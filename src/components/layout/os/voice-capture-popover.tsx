...
export function VoiceCapturePopover() {
  ...
  return (
    <div className="fixed top-12 right-4 z-[95] w-[360px] max-w-[92vw] rounded-xl bg-white dark:bg-[#181C22] border border-zinc-200 dark:border-[#2A2F38] shadow-2xl">
      ...
      <div className="p-4">
        <div className="min-h-[88px] max-h-[200px] overflow-y-auto rounded-lg border border-zinc-200 dark:border-[#2A2F38] bg-zinc-50 dark:bg-[#14171D] px-3 py-2.5 text-base leading-relaxed text-zinc-800 dark:text-zinc-100">
        ...
        <div className="mt-3 flex items-center gap-2">
          {recording ? (
            ...
            <div className="w-full flex flex-col gap-2">
              ...
              <div className="flex items-center gap-2">
                <button type="button" onClick={() => void copy()} disabled={!text} className="flex-1 h-9 rounded-md border border-zinc-200 dark:border-[#2A2F38] text-zinc-700 dark:text-zinc-200 text-base inline-flex items-center justify-center gap-1.5 hover:bg-zinc-50 dark:hover:bg-white/10 disabled:opacity-40">
                  <Copy className="w-3.5 h-3.5" /> Copy text
                </button>
                <button type="button" onClick={start} className="h-9 px-3 rounded-md border border-zinc-200 dark:border-[#2A2F38] text-zinc-700 dark:text-zinc-200 text-base inline-flex items-center gap-1.5 hover:bg-zinc-50 dark:hover:bg-white/10">
        ...
        {!recording && !text ? (
          <button type="button" onClick={start} className="mt-2 w-full h-9 rounded-md border border-dashed border-zinc-300 dark:border-[#2A2F38] text-zinc-600 dark:text-zinc-300 text-base inline-flex items-center justify-center gap-1.5 hover:bg-zinc-50 dark:hover:bg-white/10">
