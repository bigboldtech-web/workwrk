  ...
  return (
    <header className="relative h-8 flex-shrink-0 flex items-center gap-2">
      ...
      <div className="h-full flex items-center gap-1">
        ...
        >
          <span className="w-5 h-5 rounded-md bg-zinc-900 text-white flex items-center justify-center text-xs font-semibold">
            {orgInitials(orgName)}
          </span>
          <span className="text-base font-medium text-zinc-900 leading-5 max-w-[160px] truncate">{orgName}</span>
      ...
      <div className="h-full flex items-center bg-white rounded-full border border-zinc-200 hover:border-zinc-300 hover:shadow-sm transition-all w-[520px] max-w-[44vw] pl-3 pr-1 py-0.5 gap-1.5">
        ...
        >
          ...
          <span className="text-base flex-1 text-zinc-500 truncate">
            Search tasks, docs, people, spaces…
          </span>
          <span className="text-xs text-zinc-500 px-1.5 py-0.5 rounded bg-zinc-100 border border-zinc-200 font-mono flex-shrink-0">⌘K</span>
        </button>
      ...
      <div className="h-full flex items-center gap-0.5 bg-white rounded-lg border border-zinc-200 px-1">
        ...
        <div className="relative ml-1">
          <button
            ...
            className="w-6 h-6 rounded-full text-white flex items-center justify-center text-xs font-semibold"
