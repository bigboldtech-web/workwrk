    ...
    <button
      ...
      className={
        iconOnly
          ...
          : `inline-flex items-center gap-1.5 h-7 px-2.5 rounded-md bg-zinc-100 hover:bg-zinc-200 text-zinc-900 text-sm font-semibold transition-colors flex-shrink-0${className ? " " + className : ""}`
      }
    >
