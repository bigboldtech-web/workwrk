...
export function NotificationBanner() {
  ...
  return (
    <div
      className="flex-shrink-0 h-10 flex items-center px-4 gap-3 text-base"
      style={{
    ...
    >
      ...
      <button
        type="button"
        onClick={remind}
        className="px-3 py-1 rounded-md text-sm font-medium hover:bg-black/5 transition-colors"
