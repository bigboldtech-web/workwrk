...
import { X, ChevronDown, Check, Boxes, IterationCw } from "lucide-react";
...
const INPUT_CLASSES =
  "w-full h-8 px-3 text-base bg-white border border-zinc-200 rounded-md focus:outline-none focus:border-[var(--os-brand)] focus:ring-2 focus:ring-[var(--os-brand)]/20 transition-all placeholder:text-zinc-400";
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="px-5 pt-5 pb-3 flex items-start justify-between">
          <div>
            <h2 id="create-sprint-title" className="flex items-center gap-2 text-lg font-semibold text-zinc-900">
              <IterationCw className="w-4 h-4 text-[#0073EA]" />
              Create Sprint
            </h2>
            <p className="text-base text-zinc-500 mt-1">A Sprint is a time-boxed List. Tasks get a Sprint Points field automatically.</p>
          </div>
        ...
        <div className="px-5 py-3 flex flex-col gap-4">
          ...
          {/* Start date */}
          <div className="flex flex-col gap-1.5">
            <label className="text-base font-medium text-zinc-700">Start date</label>
            <input
              type="date"
              value={startDate}
          ...
          {/* Duration */}
          <div className="flex flex-col gap-1.5">
            <label className="text-base font-medium text-zinc-700">Duration</label>
            <select
              value={weeks}
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="h-8 px-3 flex items-center text-base text-zinc-500 bg-zinc-100 rounded-md">{previewName}</div>
          </div>
        </div>
