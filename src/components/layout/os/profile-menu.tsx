...
export function ProfileMenu({ open, onClose, anchorRef }: Props) {
  ...
  return (
    <div
      ...
      className="absolute right-0 top-full mt-1.5 z-[70] w-[280px] bg-white text-zinc-900 rounded-xl shadow-2xl border border-zinc-200 overflow-hidden text-base"
    >
      {/* User header */}
      <div className="px-3 py-3 flex items-center gap-2.5">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="text-zinc-400 text-xs flex items-center gap-1 min-w-0">
      ...
      <div className="px-1.5 pt-2 pb-1.5">
        <div className="px-2 text-micro uppercase tracking-wide text-zinc-500 mb-1">Personal Tools</div>
