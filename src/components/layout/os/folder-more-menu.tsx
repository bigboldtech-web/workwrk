  ...
  if (mode === "rename") {
    return (
      <div className="bg-white rounded-xl border border-zinc-200 shadow-2xl p-3">
        <div className="text-xs uppercase tracking-wide text-zinc-400 font-semibold mb-2">
          Rename folder
        </div>
        <input
          type="text"
        ...
        <div className="flex justify-end gap-1.5 mt-2.5">
          <button
            ...
            className="h-7 px-2.5 rounded-md text-sm text-zinc-600 hover:bg-zinc-100"
          >
            Cancel
          </button>
          <button
    ...
    return (
      <div className="bg-white rounded-xl border border-zinc-200 shadow-2xl p-3">
        ...
        <div className="flex items-center gap-3">
          ...
          />
          <div className="text-sm text-zinc-500">Same icon catalog used by Spaces and Boards.</div>
        </div>
    ...
    <MenuList>
      ...
      <div className="px-1.5 pt-1 pb-0.5">
        <button
          type="button"
          onClick={onOpenShare}
          className="w-full h-8 rounded-md text-base font-medium text-white flex items-center justify-center gap-1.5 hover:opacity-90"
