  ...
  return (
    ...
    >
      <header className="px-3.5 py-2.5 border-b border-zinc-100 flex items-center justify-between">
        <span className="text-base font-semibold text-zinc-900 inline-flex items-center gap-2">
      ...
      <div className="max-h-[420px] overflow-y-auto">
        {rows === null ? (
          ...
          <div className="px-4 py-8 text-center">
            <div className="text-base text-zinc-700 font-medium">You&rsquo;re all caught up</div>
            <div className="mt-1 text-xs text-zinc-500 max-w-[260px] mx-auto">
...
function SurveysSection({
  ...
  return (
    <div className={subtle ? "border-t border-zinc-100" : ""}>
      <div className="px-3.5 pt-3 pb-1 text-micro uppercase tracking-wide text-zinc-400 font-semibold">
        {title}
      </div>
          ...
          <li key={s.id}>
            ...
            >
              ...
              <span className="flex-1 min-w-0">
                <span className="block text-base font-medium text-zinc-900 truncate">
                  {s.title}
                </span>
