...
const SPACES: Space[] = [
  {
    ...
    items: [
      ...
      { href: "/tasks/board",  label: "Sprint board", mark: "S", color: "var(--os-c-purple)" },
  ...
  },
  {
    ...
    Icon: Users,
    color: "var(--os-c-pink)",
    match: ["/people", "/organization", "/recruiting", "/onboarding", "/reviews", "/talent", "/candor", "/kra-kpi", "/workforce-planning", "/announcements", "/kudos", "/surveys"],
    items: [
