        ...
        <div className="px-5 py-4 flex flex-col gap-5">
          ...
          <div className="flex items-center justify-between pt-1">
            ...
            <button 
              ...
              className={`relative inline-flex h-4 w-7 shrink-0 cursor-pointer rounded-full transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--os-brand-rail)] focus-visible:ring-offset-2 focus-visible:ring-offset-white ${isPrivate ? "bg-[var(--os-brand-rail)]" : "bg-zinc-300"}`}
            >
              <span className={`pointer-events-none absolute top-0.5 h-3 w-3 rounded-full bg-white shadow transition-transform duration-200 ease-in-out ${isPrivate ? "translate-x-3.5" : "translate-x-0.5"}`} />
            </button>
          </div>
        </div>
