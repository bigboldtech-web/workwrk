    ...
    <>
      <div className="flex items-center gap-2">
        <button
          ...
          className="inline-flex items-center gap-1.5 h-8 px-3 rounded-md text-xs border border-zinc-200 hover:bg-zinc-50"
        >
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 h-8 px-3 rounded-md text-xs text-white bg-[var(--os-brand)] hover:bg-[var(--os-brand-hover)]"
        >
