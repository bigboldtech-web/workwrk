        ...
        <div className="flex items-center gap-1.5">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full h-7 pl-7 pr-2 rounded-md border border-zinc-200 bg-white text-sm focus:outline-none focus:border-zinc-400"
              autoFocus
            />
          </div>
          <button
            ...
            return (
              ...
              >
                ...
                <span className="flex-1 min-w-0">
                  <span className="block text-sm font-medium text-zinc-900 truncate">{c.title}</span>
                  {c.subtitle ? (
                    <span className="block text-xs text-zinc-500 truncate">{c.subtitle}</span>
                  ) : null}
                </span>
                {busy ? (
