        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-6" onClick={onClose}>
          ...
          >
            ...
            <div className="h-12 shrink-0 px-4 border-b border-zinc-100 flex items-center gap-2.5">
              ...
              <span className="text-sm font-medium text-zinc-400">Task</span>
              <div className="ml-auto flex items-center gap-1">
                {item ? (
                  <Link
                    href={`/item/${item.id}`}
                    className="inline-flex items-center gap-1.5 h-7 px-2.5 rounded-md text-sm font-medium text-zinc-500 transition-colors hover:bg-zinc-100 hover:text-zinc-800"
                ...
                {canEdit && item ? (
                  <button
                    type="button"
                    onClick={archive}
                    className="inline-flex items-center gap-1.5 h-7 px-2.5 rounded-md text-sm font-medium text-zinc-500 transition-colors hover:bg-red-50 hover:text-red-600"
                  >
...
function RailIconButton({
  ...
  return (
    ...
    >
      ...
      <span className="pointer-events-none absolute right-full top-1/2 -translate-y-1/2 mr-2 whitespace-nowrap rounded-md bg-zinc-900 px-2 py-1 text-xs font-medium text-white opacity-0 group-hover:opacity-100 transition-opacity duration-100 z-10">
        {label}
      </span>
    </button>
  );
