    ...
    <div className="rounded-lg border border-zinc-200 bg-white overflow-hidden">
      ...
      <div className="p-4">
        {initialItems.length === 0 ? (
          <div className="py-16 text-center text-xs text-zinc-500">No items to chart yet.</div>
        ) : chartType === "number" ? (
          <div className="py-10 text-center">
            ...
            <div className="mt-2 text-base text-zinc-500">{metricLabel} · all items</div>
            ...
            <div className="mt-3 flex items-center justify-center gap-3 flex-wrap text-xs text-zinc-500">
              {slices.map((s) => (
...
function Select({
  ...
  return (
    <select
      ...
      className="h-7 rounded-md border border-zinc-200 bg-white px-1.5 text-xs text-zinc-700 outline-none hover:bg-zinc-50 focus:border-zinc-400 disabled:opacity-60"
    >
      {options.map((o) => (
