  ...
  return (
    <div className="rounded-lg border border-zinc-200 bg-white overflow-hidden">
      <div className="flex h-10 items-center gap-2 border-b border-zinc-100 px-3">
        ...
        <span className="text-base font-semibold text-zinc-800 truncate">{board?.name ?? "Canvas"}</span>
        {saving ? (
          <span className="inline-flex items-center gap-1 rounded-full border border-zinc-100 bg-zinc-50 px-2 py-0.5 text-xs font-medium text-zinc-500">
