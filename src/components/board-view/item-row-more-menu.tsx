      ...
      <MorePortal anchorRef={btnRef} panelRef={panelRef} width={236} open={open} placement="below" point={point}>
        <MenuList className="min-w-[236px]" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="flex items-stretch gap-1.5 px-2.5 pt-0.5 pb-2">
            <button type="button" onClick={copyLink} className="flex-1 h-7 rounded-lg border border-zinc-200 text-sm font-medium text-zinc-600 hover:border-zinc-300 hover:bg-zinc-50 hover:text-zinc-900 transition-colors">Copy link</button>
            <button type="button" onClick={copyId} className="flex-1 h-7 rounded-lg border border-zinc-200 text-sm font-medium text-zinc-600 hover:border-zinc-300 hover:bg-zinc-50 hover:text-zinc-900 transition-colors">Copy ID</button>
