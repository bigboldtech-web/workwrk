...
export function SprintHeaderStrip({ boardId, canEdit, sprint, items, statuses }: SprintHeaderStripProps) {
  ...
  return (
    <div className="mb-2 flex flex-wrap items-center gap-3 rounded-lg border border-zinc-200 bg-zinc-50 px-3 py-1.5">
      ...
      <span
        className={`inline-flex items-center h-5 rounded-[5px] px-2 text-micro font-semibold uppercase text-white ${
      ...
      <span className="text-base font-semibold text-zinc-900">{done} / {total}</span>
            ...
            <div className="flex flex-col gap-3 p-3">
              <div className="flex flex-col gap-1">
                ...
                <input
                  ...
                  className="w-full h-8 px-2.5 text-base bg-white border border-zinc-200 rounded-md"
                />
              </div>
              <div className="flex flex-col gap-1">
              ...
              <button
                ...
                className="h-8 px-4 text-base font-medium rounded-md text-white bg-zinc-900 hover:bg-zinc-800 disabled:opacity-50"
              >
                Save
              </button>
            </div>
