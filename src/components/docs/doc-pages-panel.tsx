    ...
    return (
      <div key={row.id}>
        <div
          ...
          className={`group/prow flex items-center gap-1.5 h-7 pr-1 rounded-md text-base cursor-pointer ${
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between px-2 pb-1">
        <span className="text-xs font-semibold uppercase tracking-wide text-zinc-400">Pages</span>
        <button
          type="button"
          onClick={onCollapse}
          title="Hide pages"
      ...
      <button
        ...
        className="flex w-full items-center gap-1.5 h-7 px-2 rounded-md text-base font-medium text-zinc-500 hover:bg-zinc-50 hover:text-zinc-700"
      >
