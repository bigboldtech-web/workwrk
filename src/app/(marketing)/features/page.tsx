...
import {
  ...
  ArrowUpRight, CheckCircle2, Quote, Sparkles, Lock, Package,
  Shield, Megaphone, Crosshair, Lightbulb, Grid3x3, Wrench,
  ClipboardList,
} from "lucide-react";
import {
...
export const metadata: Metadata = {
  title: "Features — WorkwrK | The Complete Business Operating System",
  description:
    "Every module: People, KRAs, KPIs, OKRs, SOPs, Reviews, Tasks, Assets, Policies, Announcements, Recognition, AI, Analytics, Access Control, Surveys, Talent Grid, Ideas, Tools, and more.",
  openGraph: {
    title: "WorkwrK Features — One Platform for Your Entire Business",
    description:
      "23+ modules covering people, performance, processes, and goals. AI-powered. Fully access-controlled. Built for scale.",
  },
};
...
const modules = [
  ...
  },
  {
    ...
    subtitle: "Stop staring at blank screens. Generate complete modules with AI.",
    desc: "Built-in AI generates KRAs and KPIs from a job role, drafts SOPs from a process name, writes your company profile from a domain, and answers business questions from your real data — all using your company context, not generic templates.",
    features: [
      "Generate 5 KRAs with 15 KPIs from a job role description",
      "Draft step-by-step SOP playbooks in seconds",
      "AI-generated company mission, vision and values",
      "Natural language business intelligence queries",
      "AI uses your company profile as context for everything",
      "Editable previews — review before saving",
    ],
  },
  {
    id: "access-control",
    ...
    subtitle: "You decide who can do what. Every action, every module.",
    desc: "A complete permission matrix lets Company Admins control exactly what each role can access — from creating SOPs to deleting policies. 17 modules with ~5 actions each, sensible defaults, and the ability to promote any team member to co-admin.",
    features: [
      "17 modules with granular per-action toggles",
      "10 access levels from Agent to Super Admin",
      "Sensible role-based defaults out of the box",
      "Promote any member to Company Admin",
      "Last-admin protection — can't lock yourself out",
      "Server-enforced — not just UI hiding",
    ],
  },
  {
    id: "okrs",
    ...
    subtitle: "Align your whole company around what matters this quarter.",
    desc: "Set Objectives at company, team, or individual level with measurable Key Results. Track check-ins, see progress over time, and link OKRs to KRAs and tasks for end-to-end traceability.",
    features: [
      "Company, team, and individual OKR levels",
      "Multiple Key Results per Objective with weighted progress",
      "Quarterly views with check-in history",
      "Auto-rolled progress aggregation",
      "Owner assignments with notification",
      "Links to KRAs, KPIs and tasks",
    ],
  },
  {
    id: "assets",
    ...
    subtitle: "Track every laptop, phone, monitor, and ID card you give your team.",
    desc: "Manage company assets from purchase to retirement. Each asset has type, brand, model, serial/IMEI, condition, purchase date, and warranty expiry. Assign during onboarding, collect during offboarding — with full history.",
    features: [
      "15 asset types — laptops, phones, monitors, vehicles, ID cards",
      "Serial number and IMEI tracking",
      "Purchase cost, warranty expiry, condition tracking",
      "Assign and reassign with full audit trail",
      "Per-employee asset view in their profile",
  ...
  },
  {
    ...
    subtitle: "Document your rules. Track who's read them.",
    desc: "Publish HR policies, code of conduct, leave rules, and compliance documents. Employees acknowledge each policy with a click — and you get instant compliance reports showing exactly who's read what.",
    features: [
      "Rich text editor for policy authoring",
      "Required acknowledgment with timestamps",
      "Automatic notifications when published",
      "Per-policy compliance dashboard",
      "Categorize by type (HR, Security, Compliance)",
      "Version tracking",
    ],
  },
  {
    ...
    color: "#EC4899",
    title: "Announcements",
    subtitle: "Get the right message to the right people at the right time.",
    desc: "Push time-sensitive updates that show on every team member's dashboard. Set priority, expiration dates, and target specific audiences. Auto-notifies everyone via in-app and email.",
    features: [
      "Priority levels (Normal, Important, Urgent)",
      "Auto-expiration after a date",
      "Pin critical announcements to the top",
      "Audience targeting by department or role",
      "Email + in-app notifications on publish",
      "Dismissable per user with tracking",
    ],
  },
  {
    id: "talent-grid",
    ...
    subtitle: "Visualize potential vs performance for everyone.",
    desc: "The classic 9-box matrix — high/medium/low performance against high/medium/low potential. Identify your stars, your loyal contributors, your underperformers, and where to invest in development.",
    features: [
      "Drag-and-drop placement",
      "Auto-suggest based on review scores",
      "Per-period snapshots",
      "Action recommendations per box",
      "Filter by department or manager",
      "Export to PDF for board reviews",
    ],
  },
  {
    id: "ideas",
    ...
    color: "#F59E0B",
    title: "Ideas Board",
    subtitle: "Crowdsource innovation from your team.",
    desc: "Anyone can submit ideas. Everyone can vote and comment. Managers review, accept, and convert top ideas into projects. Builds a culture where great suggestions get heard and acted on.",
    features: [
      "Open submission for all team members",
      "Voting and comments",
      "Manager review and approval workflow",
      "Status tracking (New, Reviewing, Accepted, Implemented)",
      "Tag by category or department",
      "Convert ideas into tasks or OKRs",
    ],
  },
  {
    id: "tools",
    icon: <Wrench size={28} />,
    color: "#06B6D4",
    title: "Tools & Credential Vault",
    subtitle: "Stop sharing passwords on Slack.",
    desc: "Securely store credentials for tools your team uses — login URLs, usernames, passwords, API keys, notes. Share with specific employees who need access. Eliminates the 'who has the Figma password?' problem.",
    features: [
      "Encrypted credential storage",
      "Share with specific people, not the whole org",
      "Show/hide password toggle",
      "Copy-to-clipboard for credentials",
      "Notes and onboarding instructions per tool",
  ...
  },
  {
    ...
    color: "#14B8A6",
    title: "Pulse Surveys",
    subtitle: "Take the temperature of your team — anonymously, regularly.",
    desc: "Run lightweight pulse surveys to track engagement, satisfaction, and morale. Multiple question types, anonymous responses, and aggregate dashboards so managers see trends without identifying individuals.",
    features: [
      "Multiple question types (rating, multiple choice, text)",
      "Anonymous responses to encourage honesty",
      "Schedule recurring surveys",
      "Aggregate dashboards for managers",
