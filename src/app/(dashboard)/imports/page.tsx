  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-4">
        ...
        <div className="grid max-w-3xl grid-cols-1 gap-3 sm:grid-cols-2">
          ...
          >
            <div className="mb-2 flex items-center gap-2">
              ...
              <span className="text-[14.5px] font-semibold text-zinc-900">CSV → Database</span>
          ...
          >
            <div className="mb-2 flex items-center gap-2">
              ...
              <span className="text-[14.5px] font-semibold text-zinc-900">People CSV</span>
              <ArrowRight className="ml-auto h-3.5 w-3.5 text-zinc-300 transition-transform group-hover:translate-x-0.5" />
            </div>
            <p className="text-[13.5px] text-zinc-500">
        ...
        <div className="mb-2 mt-6 text-[12px] font-semibold uppercase tracking-wide text-zinc-400">
          Coming soon
        </div>
        <div className="flex max-w-3xl flex-wrap gap-2">
          {COMING_SOON.map((source) => (
            <span
              key={source}
              className="inline-flex h-8 items-center gap-1.5 rounded-lg border border-dashed border-zinc-200 px-3 text-[13.5px] text-zinc-400"
            >
