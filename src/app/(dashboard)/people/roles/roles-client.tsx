    ...
    <div className="flex flex-col h-full bg-white">
      <div className="px-6 pt-4 pb-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/people/departments" className="inline-flex items-center gap-1.5 h-8 px-3 rounded-md text-base text-zinc-700 border border-zinc-200 hover:bg-zinc-50">
