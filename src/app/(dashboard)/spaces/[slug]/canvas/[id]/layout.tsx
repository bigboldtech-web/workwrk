// /spaces/[slug]/canvas/[id]: the Work address of a canvas in a Space.
//
// A canvas opened from Work stays in Work. {slug} is the canvas's own
// Space; the gate corrects any other slug before the editor mounts.
...
export default async function WorkSpaceCanvasLayout({
  children,
  params,
}: {
  children: ReactNode;
  ...
  return (
    <WorkObjectGate kind="canvas" id={id} at={{ scope: "space", slug }}>
      {children}
    </WorkObjectGate>
  );
}
