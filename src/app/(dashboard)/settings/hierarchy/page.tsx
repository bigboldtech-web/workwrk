  ...
  return (
    <div className="px-6 pt-6">
      <header className="mb-1 flex items-center gap-2">
        ...
        <h1 className="text-xl font-semibold tracking-[-0.01em] text-zinc-900">Hierarchy</h1>
      </header>
      ...
      {users === null ? (
        ...
        <div className="rounded-xl border border-zinc-200 bg-white px-4 py-6 text-center text-base text-zinc-400">
          No people yet.
        </div>
      ) : (
  ...
  return (
    <div>
      ...
      >
        ...
        <span className="truncate text-base font-medium text-zinc-900">{nameOf(user)}</span>
        ...
        {kids.length > 0 ? (
          <span className="shrink-0 text-xs text-zinc-400">{kids.length} report{kids.length > 1 ? "s" : ""}</span>
        ) : null}
      </div>
