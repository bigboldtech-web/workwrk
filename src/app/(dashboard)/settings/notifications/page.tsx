    ...
    <div className="px-6 pt-6">
      ...
      {loading ? (
        ...
        <div className="max-w-2xl">
          {/* ── Inbox (in-app) ─────────────────────────────────────── */}
          <h2 className="mb-2 text-base font-semibold text-zinc-900">Inbox</h2>
          ...
          <h2 className="mb-2 text-base font-semibold text-zinc-900">Email</h2>
          <div className="mb-1.5 text-sm font-medium uppercase tracking-wide text-zinc-400">Task &amp; activity</div>
          <div className="mb-5 overflow-hidden rounded-xl border border-zinc-200 bg-white">
            <div className="flex items-center justify-between gap-4 border-b border-zinc-100 px-4 py-3">
              <div className="min-w-0">
                <div className="text-base font-medium text-zinc-900">Email notifications</div>
                <div className="text-sm text-zinc-500">Master switch for the task &amp; activity emails below</div>
              </div>
              <Switch
                checked={emailMaster}
          ...
          <div className="mb-1.5 text-sm font-medium uppercase tracking-wide text-zinc-400">Workflow &amp; HR</div>
