  ...
  return (
    <div className="relative" style={{ width: size, height: size }}>
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        <span className="text-xl font-semibold leading-none tabular-nums text-zinc-900">
          {rate}%
        </span>
        <span className="mt-1 text-micro uppercase tracking-wide text-zinc-400">success</span>
      </div>
    </div>
  );
}
          ...
          <div className="mx-auto max-w-5xl space-y-4">
              ...
              {SEVERITY_META.map((s) => {
                ...
                return (
                  <div key={s.key} className={`${CARD} p-4`}>
                    ...
                    <div
                      className="mt-2 text-xl font-semibold leading-none tabular-nums"
            ...
            {health.totals.total === 0 ? (
              ...
              <div className={`${CARD} flex flex-col items-center px-6 py-14`}>
                ...
                <div className="mt-3 text-base font-semibold text-zinc-900">No runs yet</div>
                ...
                <Link
                  ...
                  className="mt-4 text-base font-medium text-[#0073EA] hover:underline"
                >
                  Go to workflows →
                </Link>
              </div>
              ...
              <div className="grid grid-cols-1 gap-3 lg:grid-cols-[300px_1fr]">
                ...
                <div className={`${CARD} flex flex-col items-center p-4`}>
                  <div className="self-start text-base font-semibold text-zinc-900">
                    Success rate
                  </div>
                  <div className="mt-3">
                ...
                <div className={`${CARD} p-4`}>
                  <div className="flex items-baseline justify-between">
                    <div className="text-base font-semibold text-zinc-900">Recent failures</div>
                    <Link
                      ...
                      {failures.map((run) => (
                        ...
                        >
                          <span
                            ...
                            aria-hidden
                          />
                          <span className="w-44 shrink-0 truncate text-base font-medium text-zinc-900">
