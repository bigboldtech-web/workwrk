...
function MiniTable({
  ...
  return (
    <div className={`${CARD} p-4`}>
      ...
      {rows.length === 0 ? (
        <div className="py-5 text-sm text-zinc-400">Nothing yet this month.</div>
      ) : (
        <div className="mt-1.5">
          {rows.map((r) => (
            <div
              key={r.key}
              className="flex h-7 items-center gap-2 border-b border-zinc-100 text-base last:border-0"
            >
          ...
          <div className="mx-auto max-w-5xl space-y-4">
            ...
            <div className={`${CARD} p-4`}>
              <div className="flex items-baseline justify-between">
                <div className="text-base font-semibold text-zinc-900">Actions used</div>
            ...
            {/* Daily usage */}
            <div className={`${CARD} p-4`}>
              <div className="text-base font-semibold text-zinc-900">Daily usage</div>
              {usage.month.used === 0 ? (
                <div className="flex h-[180px] items-center justify-center text-base text-zinc-400">
