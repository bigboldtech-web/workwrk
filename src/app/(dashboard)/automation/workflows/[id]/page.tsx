...
const INPUT =
  "h-7 rounded-md border border-zinc-200 bg-white px-2 text-base text-zinc-800 outline-none placeholder:text-zinc-400 focus:border-zinc-400";
const OUTLINE_PILL =
  "inline-flex h-7 items-center gap-1 rounded-md border border-zinc-200 bg-white px-3 text-base font-medium text-zinc-700 hover:bg-zinc-50";
/** Monday-style fillable sentence token. */
const TOKEN =
  "inline-flex max-w-full items-center gap-1 border-b-2 pb-0.5 text-xl font-semibold leading-tight transition-colors";

function NotEmittingChip() {
  return (
    <span className="inline-flex h-[16px] items-center rounded-md border border-amber-200 bg-amber-50 px-1.5 text-micro font-semibold uppercase tracking-wide text-amber-700">
      not emitting yet
    </span>
  );
}
            ...
            <MenuList className="overflow-hidden">
              <div className="flex h-8 items-center gap-2 border-b border-zinc-100 px-3 dark:border-[#2A2F38]">
                ...
                <input
                  ...
                  className="w-full bg-transparent text-base text-zinc-800 outline-none placeholder:text-zinc-400 dark:text-zinc-200"
                />
              </div>
              <div className="max-h-[280px] overflow-y-auto py-1">
                ...
                {filtered.length === 0 ? (
                  <div className="px-3 py-3 text-sm text-zinc-400">No people found</div>
                ) : (
  ...
  if (param.type === "text") {
    return (
      <textarea
        ...
        className="w-full rounded-md border border-zinc-200 bg-white px-2 py-1.5 text-base text-zinc-800 outline-none placeholder:text-zinc-400 focus:border-zinc-400"
      />
    );
  }
  return (
      ...
      <div className="flex flex-1 overflow-hidden">
        <div className="flex-1 overflow-y-auto px-8 py-10">
          <div className="mx-auto max-w-2xl">
            ...
            {selectedTrigger ? (
              <p className="mt-1.5 text-sm text-zinc-400">{selectedTrigger.description}</p>
            ) : null}
            ...
            <div className="space-y-4">
              {actionRows.length === 0 ? (
                <div className="flex flex-wrap items-center gap-x-3 gap-y-2">
                  <span className="text-xl font-semibold leading-tight text-zinc-900">Then</span>
                  <ActionToken
                ...
                actionRows.map((row, idx) => {
                  ...
                  return (
                    <div key={row._id}>
                      <div className="flex flex-wrap items-center gap-x-3 gap-y-2">
                        <span className="text-xl font-semibold leading-tight text-zinc-900">
                          {idx === 0 ? "Then" : "and then"}
                        </span>
                        <ActionToken
                          actions={actionsCatalog}
                        ...
                        <div className="mt-2 grid grid-cols-1 gap-x-4 gap-y-2 rounded-xl border border-zinc-200 p-3 sm:grid-cols-2">
                          {catalog.params.map((param) => (
                            ...
                            >
                              ...
                              />
                              {param.help ? (
                                <p className="mt-0.5 text-xs text-zinc-400">{param.help}</p>
                              ) : null}
                            </div>
                          ))}
                        </div>
        ...
        <div className="hidden w-[300px] shrink-0 overflow-y-auto border-l border-zinc-100 p-4 lg:block">
          <div className={`${CARD} p-3`}>
            ...
            <textarea
              ...
              className="mt-1 w-full rounded-md border border-zinc-200 bg-white px-2 py-1.5 text-sm text-zinc-800 outline-none placeholder:text-zinc-400 focus:border-zinc-400"
            />
            ...
            <div className="mt-3 space-y-1 border-t border-zinc-100 pt-2 text-xs text-zinc-500">
          ...
          <div className={`${CARD} mt-3 p-3`}>
            <div className="flex items-baseline justify-between">
              <div className="text-sm font-semibold text-zinc-900">Run history</div>
              <Link
