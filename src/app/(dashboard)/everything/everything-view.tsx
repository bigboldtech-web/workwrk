    ...
    (row: BoardItemRow) => {
      ...
      return (
        <Link
          ...
          className="inline-flex items-center gap-1 shrink-0 max-w-[160px] h-[18px] px-1.5 rounded bg-zinc-100 text-xs text-zinc-500 hover:bg-zinc-200 hover:text-zinc-700 transition-colors"
