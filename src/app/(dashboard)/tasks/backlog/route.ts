// /tasks/backlog: the legacy Backlog list: the undated tasks. My work's Due date
// grouping carries an "Unscheduled" bucket, which is the same set.
//
...
export async function GET() {
  // `bucket=nodate` seeds My work's "No date" due filter, which is the set
  // this page was. Without it the bookmark lands on all of My work and the
  // undated tasks are a scroll away rather than the page.
  permanentRedirect("/my-work?group=due&bucket=nodate");
}
