    ...
    <>
      ...
      <div className="mx-auto max-w-6xl px-6 py-10">
        <div className="mb-7 text-center">
          <h2 className="text-lg font-semibold tracking-[-0.01em] text-zinc-900">How do you want to document this?</h2>
          <p className="mt-1.5 text-base text-zinc-500">SOPs work four different ways. Pick the one that fits how your team will actually consume it.</p>
        </div>
          ...
          {TYPES.map((t) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="mt-3 text-base font-semibold text-zinc-900">{t.label}</h3>
                <p className="mt-1 text-base leading-relaxed text-zinc-500">{t.tagline}</p>
        ...
        <div className="mt-5 flex items-center justify-center gap-2 rounded-lg border border-blue-100 bg-blue-50/50 px-4 py-2.5 text-center text-base text-zinc-600">
