// /assigned-comments: a stub with no data of its own. Comment notifications land in the Inbox as task_comment rows.
//
...
export async function GET() {
  permanentRedirect("/inbox?tab=primary&type=task_comment");
}
