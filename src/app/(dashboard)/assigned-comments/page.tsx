  ...
  return (
    <div className="flex flex-col h-full bg-white">
      ...
      <div className="flex items-center gap-2 border-b border-zinc-100 !px-4 py-2">
        ...
        <button
          type="button"
          className="inline-flex h-7 items-center gap-1.5 rounded-full border border-zinc-200 bg-white !px-3 text-base text-zinc-600 hover:bg-zinc-50"
        >
        ...
        <button
          ...
          className={`inline-flex h-7 items-center gap-1.5 rounded-full border border-zinc-200 !px-3 text-base transition-colors ${
            resolved
              ? "font-medium"
        ...
        {searchOpen ? (
          <div className="relative">
            ...
            <input
              ...
              placeholder="Search"
              className="h-8 w-[180px] rounded-md border border-zinc-200 bg-white pl-8 pr-3 text-base focus:border-zinc-400 focus:outline-none"
            />
          </div>
        ) : (
          <button
            ...
            className="inline-flex h-8 items-center gap-1.5 rounded-md !px-2.5 text-base text-zinc-500 hover:bg-zinc-100"
          >
      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center px-6 py-12">
        ...
        <p className="mb-5 text-xl font-semibold text-zinc-900">No results found</p>
        <button
          type="button"
          onClick={clearFilters}
          className="rounded-md border border-zinc-200 bg-white !px-4 py-2 text-base text-zinc-700 hover:bg-zinc-50"
        >
          Clear filters
        </button>
      </div>
  ...
  return (
    <div className="relative">
      <button
        type="button"
        onClick={() => setOpen((v) => !v)}
        className="inline-flex h-7 items-center gap-1.5 rounded-full border !px-3 text-base"
            ...
            {options.map((opt) => (
              <li key={opt}>
                <button
                  ...
                  className={`w-full text-left !px-3 py-1.5 text-base hover:bg-zinc-50 ${
