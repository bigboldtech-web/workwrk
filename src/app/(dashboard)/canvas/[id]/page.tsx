    ...
    <div className="wbc">
      ...
      <header className="wbc__bar">
        ...
        <button
          type="button"
          onClick={copyLink}
          className="inline-flex h-7 items-center gap-1.5 rounded-md border border-zinc-200 bg-white px-2.5 text-base font-medium text-zinc-700 transition-colors hover:bg-zinc-50 hover:text-zinc-900 shrink-0"
        >
