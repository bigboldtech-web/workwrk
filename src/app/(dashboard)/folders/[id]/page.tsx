                      ...
                      return (
                        <li key={b.id} className="group/board grid grid-cols-[1fr_120px_160px_120px] items-center px-3 py-2 border-b border-zinc-100 last:border-b-0 hover:bg-zinc-50 transition-colors">
                          ...
                          <span className="flex items-center gap-2">
                            ...
                            <span className="text-[11.5px] text-zinc-500 tabular-nums shrink-0">{done}/{total}</span>
                          </span>
            ...
            <Card title="Docs">
              {docs.length === 0 ? (
                ...
                <ul className="-mx-2">
                  {docs.map((d) => (
                    <li key={d.id}>
                      <Link href={`/docs/${d.id}`} className="flex items-center gap-2 px-2 py-1.5 hover:bg-zinc-50 transition-colors rounded text-[13.5px]">
