    ...
    <div className="min-h-screen bg-white text-slate-900 antialiased grid lg:grid-cols-2">
      ...
      <div className="flex flex-col px-6 sm:px-10 lg:px-16 py-10">
        <Link href="/" className="inline-flex items-center gap-2 group w-fit">
          <span className="w-8 h-8 rounded-lg bg-zinc-900 flex items-center justify-center">
            <span className="text-white text-base font-semibold tracking-tight">W</span>
          </span>
          <span className="font-semibold text-lg tracking-tight">workwrk</span>
        </Link>
        ...
        <div className="text-sm text-slate-500 mt-8 flex items-center justify-between gap-4 max-w-md w-full mx-auto flex-wrap">
      ...
      <div className="hidden lg:flex flex-col justify-center px-12 xl:px-20 py-12 bg-zinc-50/60 border-l border-zinc-100 relative overflow-hidden">
        <div className="relative max-w-md">
          <div className="inline-flex items-center gap-1.5 text-sm font-semibold text-[#0073EA] bg-white border border-blue-200/70 px-3 py-1.5 rounded-full shadow-sm">
            <Sparkles size={12} className="text-[#0073EA]" /> Built like Lego. Runs your whole business.
          </div>

          <h2 className="text-3xl xl:text-[2.5rem] font-semibold tracking-tight text-slate-900 mt-6 leading-[1.1]">
          ...
          <div className="grid grid-cols-2 gap-2.5 mt-7">
            {[
              ...
              <div key={p.label} className={`flex items-start gap-2.5 text-base text-slate-700 bg-white border rounded-xl px-3 py-2.5 transition hover:shadow-sm ${p.color.split(" ")[2]}`}>
          ...
          <div className="flex items-center gap-3 mt-6 text-xs text-slate-500 font-medium">
          ...
          <figure className="mt-7 bg-white/70 backdrop-blur border border-slate-200/70 rounded-2xl p-5 shadow-sm">
            ...
            <figcaption className="flex items-center gap-2.5 mt-4">
              <span className="w-8 h-8 rounded-full bg-zinc-900 text-white text-sm font-semibold flex items-center justify-center">MS</span>
