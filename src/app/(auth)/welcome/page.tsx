            ...
            {focusOptions.map((o) => (
              ...
              >
                <div className="flex items-center justify-between gap-3">
                  <span className="text-base font-semibold text-zinc-900">{o.label}</span>
                  {focus === o.key && (
                ...
                <p className="text-base text-zinc-500 leading-relaxed m-0">{o.body}</p>
                <div className="flex flex-wrap gap-1.5">
                  {o.modules.map((m) => (
                    <span
                      key={m}
                      className={`h-5 inline-flex items-center px-2 rounded-[5px] text-xs font-medium ${
                        focus === o.key
      ...
      {step === 2 && (
        <>
          ...
          <div className="mt-4 px-4 py-3 rounded-lg border border-zinc-200 bg-zinc-50 flex items-center justify-between">
            <span className="text-xs uppercase tracking-wide text-zinc-400">Focus</span>
