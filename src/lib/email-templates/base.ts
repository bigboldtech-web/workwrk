...
<head>
  ...
  <style>
    ...
    .logo span { font-size: 20px; font-weight: 700; color: #A78BFA; }
    ...
    .btn { display: inline-block; padding: 10px 24px; background: #7C3AED; color: #ffffff !important; text-decoration: none; border-radius: 8px; font-size: 14px; font-weight: 500; }
