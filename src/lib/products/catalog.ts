...
export const PRODUCT_CATALOG: CatalogProduct[] = [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    description:
      "Leads, accounts, contacts, opportunities, deal pipeline (drag-drop kanban by stage), activities (call/email/meeting logs), email integration. The Salesforce-for-SMB.",
    iconKey: "TrendingUp",
    hue: "green",
    suite: "SALES",
    tier: "PLUS",
  ...
  // ─────────────────────────────────────────────
  {
    ...
    name: "WorkwrK Campaigns",
    tagline: "Plan, run, measure marketing",
    description:
      "Campaign planning across channels, budget tracking, attribution, performance dashboards. Replaces fragmented Asana boards + spreadsheets.",
    iconKey: "Megaphone",
    hue: "amber",
    suite: "MARKETING",
    tier: "PLUS",
    ...
    seededAgents: ["mira-campaign-manager"],
  },
  {
  ...
  // ─────────────────────────────────────────────
  {
    slug: "workwrk-dev",
    name: "WorkwrK Dev",
    tagline: "Sprints, bugs, epics, releases",
    description:
      "Sprint planning + boards, velocity + burndown, epic/story/bug hierarchy, release management. Jira/Linear for the eng team inside WorkwrK.",
    iconKey: "Code",
    hue: "violet",
    suite: "ENGINEERING",
    tier: "PLUS",
  ...
  // ─────────────────────────────────────────────
  {
    ...
    name: "WorkwrK Contracts",
    tagline: "CLM: templates, e-sign, renewals",
    description:
      "Contract templates, clause library, e-signature, renewal tracking + alerts, party + counterparty management. Ironclad-lite.",
    iconKey: "FileText",
    hue: "blue",
    suite: "LEGAL",
    tier: "SUITE",
    ...
    seededAgents: ["leila-contract-reviewer"],
    seededIntegrations: ["docusign", "dropbox-sign"],
  },
  {
    slug: "workwrk-privacy",
    name: "WorkwrK Privacy",
    tagline: "DSARs, consent, DPIAs",
    description:
      "Data subject access requests, consent records, vendor DPIAs, privacy impact assessments. GDPR/CCPA compliance.",
    iconKey: "Shield",
    hue: "rose",
    suite: "LEGAL",
    tier: "SUITE",
    ...
    displayOrder: 810,
    pathPrefix: "/privacy",
    seededAgents: ["priva-privacy-officer"],
  },
